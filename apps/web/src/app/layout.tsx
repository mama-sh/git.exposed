  ...
  return (
    <html lang="en" className={cn(geistSans.variable, geistMono.variable, 'dark')}>
      <body className="font-sans antialiased">
        ...
        <header style={{ viewTransitionName: 'site-header' }} className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 backdrop-blur-md bg-background/70 border-b border-ds-border/10">
          <Link href="/" className="flex items-center gap-2 text-lg font-extrabold tracking-tighter leading-none text-slate-200 hero-glow">
            <img src="/logo.svg" alt="" className="h-7 w-7" aria-hidden="true" />
            <span>git.<span className="text-red-500">exposed</span></span>
          </Link>
        </header>
