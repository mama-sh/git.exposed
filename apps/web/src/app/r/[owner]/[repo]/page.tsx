  ...
  return (
    <div className="min-h-dvh bg-background text-slate-200">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        {children}
        <footer className="text-center text-slate-500 text-xs mt-10 pt-6 border-t border-ds-border/30">
          Generated by <a href="https://git.exposed" className="text-slate-500 hover:text-slate-300" target="_blank" rel="noopener">git.exposed</a> — Is your code exposed?
        </footer>
      </div>
    </div>
  );
    ...
    <div className="min-h-dvh bg-background text-slate-200">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mt-10 p-5 rounded-lg border border-ds-border/30 bg-ds-muted/50">
          ...
          <div className="space-y-3">
            <div>
              <span className="text-[0.65rem] text-slate-500 block mb-1">README badge</span>
